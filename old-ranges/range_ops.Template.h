...
inline
typename binary_range_traits <typename std::multiplies< typename std::iterator_traits<Iter1>::value_type>,
			      range<Iter1>,  range<Iter2> >::range
operator*(const range<Iter1> range1,  const range<Iter2> range2)
{
  return make_binary_range(std::multiplies<typename std::iterator_traits<Iter1>::value_type>(), range1, range2);
}

template <class Iter>
inline
typename unary_range_traits<std::binder1st<std::multiplies<double> >, range<Iter> > ::range
operator*(double x, const range<Iter>& range)
{
  return make_unary_range(std::bind1st(std::multiplies<double>(), x),
			  range);
}
...
template <class Iter1,class Iter2>
inline
typename binary_range_traits<std::plus<typename std::iterator_traits<Iter1>::value_type>,
			     range<Iter1>,  range<Iter2> >::range
operator+(const range<Iter1> range1,  const range<Iter2> range2)
{
  return make_binary_range(std::plus<typename std::iterator_traits<Iter1>::value_type>(), range1, range2);
}

template <class Iter>
inline
typename unary_range_traits<std::binder1st<std::plus<double> >, range<Iter> > ::range
operator+(double x, const range<Iter>& range)
{
  return make_unary_range(std::bind1st(std::plus<double>(), x),
			  range);
}
...
template <class Iter1,class Iter2>
inline
typename binary_range_traits<std::divides<typename std::iterator_traits<Iter1>::value_type>,
			     range<Iter1>,  range<Iter2> >::range
operator/(const range<Iter1> range1,  const range<Iter2> range2)
{
  return make_binary_range(std::divides<typename std::iterator_traits<Iter1>::value_type>(), range1, range2);
}

template <class Iter>
inline
typename unary_range_traits<std::binder2nd<std::divides<double> >, range<Iter> > ::range
operator/(const range<Iter>& range,double x)
{
  return make_unary_range(std::bind2nd(std::divides<double>(), x),
			  range);
}

template <class Iter>
inline
typename unary_range_traits<std::binder1st<std::divides<double> >, range<Iter> > ::range
operator/(double x,const range<Iter>& range)
{
  return make_unary_range(std::bind1st(std::divides<double>(), x),
			  range);
}
...
template <class Iter1,class Iter2>
inline
typename binary_range_traits<std::minus<typename std::iterator_traits<Iter1>::value_type>,
			     range<Iter1>,  range<Iter2> >::range
operator-(const range<Iter1> range1,  const range<Iter2> range2)
{
  return make_binary_range(std::minus<typename std::iterator_traits<Iter1>::value_type>(), range1, range2);
}  

template <class Iter>
inline
typename unary_range_traits<std::binder1st<std::minus<double> >, range<Iter> > ::range
operator-(double x, const range<Iter>& range)
{
  return make_unary_range(std::bind1st(std::minus<double>(), x),
			  range);
}

template <class Iter>
inline
typename unary_range_traits<std::binder2nd<std::minus<double> >, range<Iter> > ::range
operator-(const range<Iter>& range,double x)
{
  return make_unary_range(std::bind2nd(std::minus<double>(), x),
			  range);
}
