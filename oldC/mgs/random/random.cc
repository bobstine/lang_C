// $Id: random.cc,v 1.2 2002/06/17 14:32:50 bob Exp $
...
{
  cout << "Random generator set from system clock\n";
...
void
MarsagliaGenerator::write_to (ostream& output) const
{
  output << "Marsaglia) " << mState << endl;
  for (int i=0; i<24; ++i)
    output << mState[i] << " ";
}
...
void
SuperDuperGenerator::write_to (ostream& output) const
{
  output << "Super Duper) " << mState << endl;
  for (int i=0; i<6; ++i)
    output << mState[i] << " ";
}
...
void
WichmanHillGenerator::write_to (ostream& output) const
{
  output << "Wichman-Hill) " << mState << endl;
  for (int i=0; i<4; ++i)
    output << mState[i] << " ";
}
...
void
TauswortheGenerator::write_to (ostream& output) const
{
  output << "Tausworthe) " << mState << endl;
  for (int i=0; i<4; ++i)
    output << mState[i] << " ";
}
