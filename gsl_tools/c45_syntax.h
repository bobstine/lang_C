// $Id: c45_syntax.h,v 1.5 2004/09/04 11:21:35 foster Exp $  -*- c++ -*-
...
public:
  ...
  void print_variable_names(std::ostream &) const;
  void print_sanitary_names(std::ostream &) const;
  void print_sanitary_data(std::ostream &) const;
  std::pair<std::vector<double>,std::vector<double> > mean_sd() const;
