// $Id: log_regr.h,v 1.33 2004/09/08 20:41:25 bob Exp $
#ifndef _LOG_REGR_H_
#define _LOG_REGR_H_
...
class LogisticRegression
{
 ...
 public:
  ...
  TestResult  add_predictor  (std::string const& name, Anonymous x, double xCenter, double xScale, double pToEnter, double df);
  void        remove_last_predictor();

  TestResult  add_calibrator(int df, double pToEnter);
