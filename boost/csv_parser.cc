...
int main ()
{
  ...
  // parsing a CSV list (comma separated values - strings, integers or reals)
  // this one craps out when it hits the ,, blank
  char const *plist_csv = "\"string\",\"string with an embedded \\\"\"," "12345,0.12345e4,,2,embeddedtext,noSpace";
  ...
  list_csv_item =
    !(
      confix_p('\"', *c_escape_ch_p, '\"')  // notice they define a string as a thing with quotes around it
