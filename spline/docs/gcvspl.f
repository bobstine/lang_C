...
C
      DATA Y/1.770D0,1.757D0,1.748D0,1.740D0,1.726D0,   !Noisy samples
     1      1.715D0,1.698D0,1.683D0,1.667D0,1.651D0,    !of the vertical
     2      1.632D0,1.612D0,1.593D0,1.572D0,1.551D0,    !coordinates (in
     3      1.530D0,1.507D0,1.483D0,1.445D0,1.428D0,    !metres) of a
     4      1.401D0,1.371D0,1.343D0,1.311D0,1.279D0,    !freely falling
     5      1.245D0,1.212D0,1.175D0,1.143D0,1.105D0,    !golf ball.
     6      1.063D0,1.029D0,0.991D0,0.953D0,0.910D0,
     7      0.869D0,0.823D0,0.779D0,0.732D0,0.691D0,
     8      0.644D0,0.595D0,0.548D0,0.501D0,0.447D0,
     9      0.395D0,0.350D0,0.294D0,0.243D0,0.185D0/
...
D    1      '   s0(i)        s1(i)        s2(i)'/)
   ...
   30    CONTINUE
D        TYPE 750, I, X(I), Y(I), (Q(IDER), IDER=0,IDM)
D 750    FORMAT(I4,':',5F13.6)
         DACCAV = DACCAV + Q(2)
         DACCSD = DACCSD + Q(2)*Q(2)
   40 CONTINUE
      ACCAV = DACCAV / N
      ACCSD = DSQRT((DACCSD - ACCAV*DACCAV)/(N-1))
      TYPE 760, ACCAV, ACCSD
