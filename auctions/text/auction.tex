...
\section{Steps in the Auction} % -------------------------------------------------------------
 ...
 experts:
 \begin{description}
  \item[Rejected feature interactions.] This expert interacts features that were
 rejected from the auction with those from the any input stream.  (I'm not
 really sure right now what this one does other than use rejected features.)
  \item[Rejected feature polynomials.] This expert builds cubic polynomials in
 rejected features to see if some simple nonlinearity might be present.
 \end{description}
