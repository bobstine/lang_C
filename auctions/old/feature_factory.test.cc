// $Id: feature_factory.test.cc,v 1.1 2008/01/20 19:55:40 bob Exp $
...
main ()
{
  ...
  // and a spline feature from a column
  std::cout << "\nTEST: Spline feature ... \n";
  ...
  // and from an interaction 
  std::cout << "\nTEST: Spline feature from interaction ... \n";
  FeatureABC* ssF2 (factory.make_unary_feature_ptr(ss.spline_operator(), xxx));
  std::cout <<   "      " << ssF2 << std::endl;
  
  // write features to a file
  const std::string test ("/Users/bob/C/auctions/test/features.dat");
  std::cout << "\nTEST: Writing features to file " << test << "\n";
