...
main ()
{
  ...
  std::cout << "TEST: average of x x duplicate interaction feature is " << xd.center() << std::endl;
  std::cout << "      " << &xd << std::endl;

  // now another interaction (that squares)
  InteractionFeature xx(&x, &x);
  std::cout << "TEST: average of xx interaction feature is " << xx.center() << std::endl;
  ...
  std::cout << "TEST: average of xxx interaction feature is " << xxx.center() << std::endl;
  std::cout << "      " << &xxx << std::endl;
  
  // an interaction of xx with xx
  InteractionFeature xxxx(&xx, &xx);
  std::cout << "TEST: average of xxxx interaction feature is " << xxxx.center() << std::endl;
