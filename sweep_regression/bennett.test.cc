/*  $Id: bennett.test.cc,v 1.1 2005/06/13 20:47:50 bob Exp $
...
int main(void)
{
  ...
  cout << "b_low " << bennett_lower_bound (2.5, a, 1.0, .001) << endl;
  cout << "p-val " << bennett_p_value     (3.5, a, 1.0) << endl;
  cout << "b_low " << bennett_lower_bound (3.5, a, 1.0, .001) << endl;
  cout << "p-val " << bennett_p_value     (4.5, a, 1.0) << endl;
  cout << "b_low " << bennett_lower_bound (4.5, a, 1.0, .001) << endl;
  cout << "p-val " << bennett_p_value     (5.5, a, 1.0) << endl;
  cout << "b_low " << bennett_lower_bound (5.5, a, 1.0, .001) << endl;
